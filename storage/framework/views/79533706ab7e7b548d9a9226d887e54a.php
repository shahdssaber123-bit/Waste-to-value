    ...
    <div class="col-md-6">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body text-center p-5">
                ...
                <a href="<?php echo e(route('user.orders.create')); ?>" class="btn btn-primary btn-lg">
    ...
    <div class="col-md-6">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body text-center p-5">
                ...
                <a href="<?php echo e(route('user.orders')); ?>" class="btn btn-success btn-lg">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\smart-waste-management\resources\views/user/dashboard.blade.php ENDPATH**/ ?>