        ...
        <div class="card text-white bg-primary border-0">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="display-6 mb-0"><?php echo e($assignedOrders); ?></p>
                </div>
        ...
        <div class="card text-white bg-success border-0">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="display-6 mb-0"><?php echo e($completedToday); ?></p>
                </div>
...
<div class="mt-5">
    <a href="<?php echo e(route('collector.orders')); ?>" class="btn btn-primary btn-lg">
        <i class="bi bi-list-task me-2"></i>View My Orders
    </a>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\smart-waste-management\resources\views/collector/dashboard.blade.php ENDPATH**/ ?>